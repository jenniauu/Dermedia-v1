document.addEventListener("DOMContentLoaded", function () {
  ...
  function createImageControls() {
    ...
    cancelBtn.innerHTML = "<img src='/js/images/deletar.png'>";
    cancelBtn.addEventListener("click", resetToUploadWidget);
    const approveBtn = document.createElement("button");
    approveBtn.className = "approve-btn";
    approveBtn.innerHTML = "<img src='/js/images/aceitar.png'>";
  ...
  function initCamera() {
    ...
    cameraBtn.innerHTML = "<img src='/js/images/capturar.png'>";
  ...
  function captureImage() {
    ...
    retakeBtn.innerHTML = "<img src='/js/images/refazer.png'>";
